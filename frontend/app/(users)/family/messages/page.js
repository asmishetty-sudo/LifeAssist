...
export default function MessagesPage() {
  ...
  return (
    <div className="flex w-full min-h-[calc(100vh-16vh)] max-h-[calc(100vh-8vh)] lg:max-h-[calc(100vh-16vh)] bg-gray-100 overflow-hidden">
      {/* CHAT LIST */}
      <div
        className={`
      ...
      >
        {!activeChat ? (
          ...
          <>
            ...
            >
              {messages.map((m) => {
                const isMine = m.sender === user.userId;
